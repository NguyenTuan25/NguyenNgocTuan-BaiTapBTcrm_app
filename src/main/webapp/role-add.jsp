                        ...
                        <div class="white-box">
                            <form action="role-add" method="post"  class="form-horizontal form-material">
                                <div class="form-group">
                                    <label for="name" class="col-md-12">Tên quyền</label>
                                    <div class="col-md-12">
                                        <input id="name" name="name" type="text" placeholder="Tên quyền"
                                            class="form-control form-control-line" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="description" class="col-md-12">Mô tả</label>
                                    <div class="col-md-12">
                                        <input id="description" name="description" type="text" placeholder="Mô tả" class="form-control form-control-line" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
