                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form action="task-add" method="post" class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    <label for="taskName" class="col-md-12">Tên công việc</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label for="jobStartDate" class="col-md-12">Ngày bắt đầu</label>
                                    <div class="col-md-12">
                                        <input name="jobStartDate" type="text" placeholder="yyyy/mm/dd"
                                            class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="jobEndDate" class="col-md-12">Ngày kết thúc</label>
                                    <div class="col-md-12">
                                        <input name="jobEndDate" type="text" placeholder="yyyy/mm/dd"
                                            class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label  class="col-md-12">Trạng thái làm việc</label>
                                    <div class="col-md-12">
