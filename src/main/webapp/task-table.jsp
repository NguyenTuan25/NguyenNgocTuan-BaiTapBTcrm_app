                                    ...
                                    <tbody>
                                    	<c:forEach var="item" items="${listTask}">
                                    		<tr>
                                            	...
                                            	<td>${item.jobEndDate}</td>
                                            	<td>${item.taskStatus}h</td>
                                            	<td>
                                                	<a href="task-edit?id=${item.id}" class="btn btn-sm btn-primary">Sửa</a>
                                                	<a href="/crm_app/task?id=${item.id}&action=delete" class="btn btn-sm btn-danger">Xóa</a>
