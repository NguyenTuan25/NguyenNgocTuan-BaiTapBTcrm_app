            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form action="job-add" method="post" class="form-horizontal form-material">
                                <div class="form-group">
                                    <label for="name" class="col-md-12">Tên dự án</label>
                                    <div class="col-md-12">
                                        <input name="name" type="text" placeholder="Tên công việc"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label for="start_date" class="col-md-12">Ngày bắt đầu</label>
                                    <div class="col-md-12">
                                        <input name="start_date" type="text" placeholder="yyyy/mm/dd"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label for="end_date" class="col-md-12">Ngày kết thúc</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <a href="job" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
