...
<body>
                            ...
                            <div class="user-bg"> <img width="100%" alt="user" src="plugins/images/large/img1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        ...
                                        <h4 value="${user.userName}" class="text-white">${user.userName}</h4>
                                        <h5 value="${user.userEmail}" class="text-white">${user.userEmail}</h5>
                                    </div>
                                </div>
                            </div>
	...
	<!-- END THỐNG KÊ -->
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="white-box">
                            <h3 class="box-title">${user.taskStatus}</h3>
